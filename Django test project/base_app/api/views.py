...
def get_roger_response(request, pk, format=None):
    if request.method == 'GET':
        ...
        return Response(serializer.data)
    elif request.method == 'POST': # Not sure how this interacts with the pk
